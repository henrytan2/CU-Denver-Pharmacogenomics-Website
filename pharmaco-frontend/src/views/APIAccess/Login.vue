...
<template>
  <div style="margin-top: 40px" class="d-flex-row">
    <span>
      An account is not needed to access this website. To access some APIs you must log in to an
      active account.
      <div style="margin-top: 10px">
        <a href="https://pharmacogenomics.clas.ucdenver.edu/api/api/public-best-resolution"
          >Best resolution API</a
        >
      </div>
      <div style="margin-top: 10px">
        <a href="https://pharmacogenomics.clas.ucdenver.edu/api/api/public-plddt-score">
          Find PLDDT score API</a
        >
      </div>
      <div style="margin-top: 10px">
        <a href="https://pharmacogenomics.clas.ucdenver.edu/api/api/public-faspr-prep"
    ...
    <div style="margin-top: 40px" class="w-100">
      ...
      <div class="d-flex"><p v-if="userStore.logInState == true" class="text-break">Token: {{ userStore.getAPITokenResponse.access }}</p></div>
